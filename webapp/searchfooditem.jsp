...
<body>
	<form action="searchrestaurant" method="post">
		<div class="search-container">
			...
			<%
			List<FoodItems> flist = (List<FoodItems>) request.getAttribute("foodlist");
			for (FoodItems i : flist) {
			%>
			<%
		if (i.getName().equalsIgnoreCase("Biryani")&& i.getRestaurant().getName().equalsIgnoreCase("mehfil")) {
		%>
				...
				<div>
					...
					<h3>
						<button class="addtocart">
							<div class="pretext"><i class="fa-solid fa-cart-shopping"></i>
		...
		%>
		<%
		if (i.getName().equalsIgnoreCase("Dum Biryani") && i.getRestaurant().getName().equalsIgnoreCase("mehfil")) {
		%>
		<div class="item-lists">
			<div>
				<img
		...
		%>
		<%
		if (i.getName().equalsIgnoreCase("Mutton Biryani")&& i.getRestaurant().getName().equalsIgnoreCase("mehfil")) {
		%>
		<div class="item-lists">
			<div>
				<img
		...
		<%
		if (i.getName().equalsIgnoreCase("Pizza") && i.getRestaurant().getName().equalsIgnoreCase("mehfil")) {
		%>
		<div class="item-lists">
			<div>
				<img
		...
		%>
		<%
		if (i.getName().equalsIgnoreCase("Shawarma")&& i.getRestaurant().getName().equalsIgnoreCase("mehfil")) {
		%>
		<div class="item-lists">
			<div>
				<img
		...
		%>
			<%
		if (i.getName().equalsIgnoreCase("sandwich") && i.getRestaurant().getName().equalsIgnoreCase("mehfil")) {
		%>
		<div class="item-lists">
			<div>
				<img
		...
		%>
		<%
		if (i.getName().equalsIgnoreCase("Ice Cream") && i.getRestaurant().getName().equalsIgnoreCase("mehfil")) {
		%>
		<div class="item-lists">
			<div>
				<img
		...
		%>
		<%
		if (i.getName().equalsIgnoreCase("Veg biryani") && i.getRestaurant().getName().equalsIgnoreCase("paradise")) {
		%>
		<div class="item-lists">
			<div>
				<img
		...
		<%
		if (i.getName().equalsIgnoreCase("Burger")  && i.getRestaurant().getName().equalsIgnoreCase("paradise")) {
		%>
		<div class="item-lists">
			<div>
				<img
			...
			<div class="item-list">
				<div class="item-de">
					...
					<i class="fa-sharp fa-solid fa-star"></i></i><span><i>4.2</i></span>
					<p class="item-m">
						<i>Burgers, American, Turkish, Portuguese, Continental, Snacks.</i>
					</p>
				</div>
				<div>
					<h1>
		...
		%>
		<%
		if (i.getName().equalsIgnoreCase("Dum Biryani") && i.getRestaurant().getName().equalsIgnoreCase("paradise")) {
		%>
		<div class="item-lists">
			<div>
				<img
		...
		%>
				...
				<%
		if (i.getName().equalsIgnoreCase("cake") && i.getRestaurant().getName().equalsIgnoreCase("paradise")) {
		%>
		<div class="item-lists">
			<div>
				<img
		...
		%>
		<%
		if (i.getName().equalsIgnoreCase("Noodles") && i.getRestaurant().getName().equalsIgnoreCase("paradise")) {
		%>
		<div class="item-lists">
			<div>
				<img
		...
		<%
		if (i.getName().equalsIgnoreCase("Orange juice") && i.getRestaurant().getName().equalsIgnoreCase("mehfil")) {
		%>
		<div class="item-lists">
			<div>
				<img
