...
.rest-name {
	color: white;
	font-family: cursive;
	text-shadow: 2px 4px 2px rgba(3, 3, 210, 0.5);
	text-align: center;
}
</style>
<link rel="stylesheet"
...
<body>
	<form action="searchitems" method="post">
		...
		List<Restaurant> rlist = (List<Restaurant>) request.getAttribute("list");
		for (Restaurant r : rlist) {
		%>


		<h1 class="rest-name"><%=r.getName()%></h1>
						...
						<button class="addtocart">
							<div class="pretext">
								<i class="fa-solid fa-cart-shopping"></i> <a
									href="addtocart?id=<%=i.getId()%>">Add to cart</a>
							</div>
						</button>
					</h3>
				</div>
		...
		<div class="item-lists">
			...
			<div class="item-list">
				<div class="item-de">
					...
					<i class="fa-sharp fa-solid fa-star"></i><span><i>3.7</i></span>
					<p class="item-m">
						<i>A no frills chicken sandwich with diced chicken, mayonnaise
							and lettuce [Energy: 474 kcal, Protein: 38.2g, Carbohydrates:
							36.6g, Fiber: 14.9g, Fat: 18.8g].</i>
					</p>
				</div>
		...
		<div class="item-lists">
			...
			<div class="item-list">
				<div class="item-de">
					...
					<i class="fa-sharp fa-solid fa-star"></i></i><span><i>4.2</i></span>
					<p class="item-m">
						<i>Serves with Mirchi ka Salan and Raita.</i>
					</p>
				</div>
				<div>
					<h1>
		...
		<div class="item-lists">
			...
			<div class="item-list">
				<div class="item-de">
					...
					<i class="fa-sharp fa-solid fa-star"></i></i><span><i>4.2</i></span>
					<p class="item-m">
						<i>A delectable Chinese delight packed with flavors, perfect
							for all noodle enthusiasts.. </i>
					</p>
				</div>
				<div>
					<h1>
			...
			<div class="item-list">
				...
				<div>
					...
					<h3>
						<button class="addtocart">
							<div class="pretext">
								<a href="addtocart?id=<%=i.getId()%>">Add to cart</a>
							</div>
						</button>
						<h3>
				</div>
		...
		<%-- <tr>
								<td rowspan="1"><%=i.getId()%></td>

				<td rowspan="1"><%=i.getName()%></td>
				<td rowspan="1"><%=i.getPrice()%></td>
			</tr>
			<tr>
				<td><button>
						<a href="addtocart?id=<%=i.getId()%>">card to cart</a>
					</button></td>
				<%
				request.setAttribute("cart", i);
				%>
				<td><a href="addtocart"><button>card to cart</button></a></td>
			</tr> --%>
		<%
		}
		%>
